...
The fitted curves now include a shaded Bayesian 90% credible band derived from the block-level posterior, highlighting uncertainty around the psychometric function estimate.
